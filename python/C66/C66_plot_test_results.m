% C66 test MAT plotter (for SLURM headless runs)
% Loads C66_test_results.mat and regenerates C66 test figures in MATLAB.

clear; clc;

base_dir = fileparts(mfilename('fullpath'));
mat_path = fullfile(base_dir, 'mat_results', 'C66_test_results.mat');
out_dir = fullfile(base_dir, 'c66_test_figures_matlab');
