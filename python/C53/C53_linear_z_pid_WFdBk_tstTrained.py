...
# Figure saving
SAVE_PREFIX = "C52_WFdBk_testTrained_"
FIG_DIR = os.path.dirname(os.path.abspath(__file__))
# Load the C52 WFdBk model trained with the APRBS envelope reference.
MODEL_SAVE_PREFIX = "C52_linear_z_pid_WFdBk_trainedGRUmodel"
...
# ------------------------ APRBS Reference (match C52 settings) ------------------------ #
APRBS_WIDTH = 15
APRBS_TAPS = (15, 14)
