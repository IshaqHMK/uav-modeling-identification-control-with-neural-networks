...
Step 1:
  ...
  - Add a PRBS wind disturbance per dataset (0 N, 1 N, 5 N).
...
def apply_wind_disturbance(step_idx, wind_force, wind_state):
    """PRBS wind disturbance generator (dataset-specific amplitude)."""
...
def run_linear_z_pid(profile_id, wind_force=0.0, wind_start_time=20.0):
    ...
    for i, t in enumerate(time):
        ...
        # Linear Z dynamics with PRBS wind disturbance after wind_start_time.
        if i >= wind_start_idx:
...
def main():
    ...
    ckpt = {
        ...
        "wind": {"start_time": WIND_START_TIME, "forces": WIND_FORCES, "mode": WIND_MODE, "settings": WIND_SETTINGS},
