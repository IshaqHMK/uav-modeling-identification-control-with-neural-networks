...
def run_linear_z_pid(profile_id):
    ...
    for i, t in enumerate(time):
        ...
        z_meas = z  # measured output used for feedback features
        err = z_ref - z_meas
        err_int += err * Ts
...
def simulate_with_model(reference, model, scaler_X, scaler_Y, seq_len, Ts):
    ...
    for i in range(n):
        ...
        # build the sequence of [measured_z, error, error_rate, error_integral]
        # and let the model predict U1 directly.
