"""
C25: Unified multi-dataset PID vanilla-RNN training with shared model.
...
TEST_DATASET = ("TEST", "quad_AGD__01_05_25_11_06_38.mat")

SEQUENCE_LENGTH = 50           # History window length (tunable)
T_CROP_SECONDS = 100.0         # Time crop applied uniformly across datasets
TRAIN_FRACTION = 0.7
...
def main():
    ...
    ckpt_path = os.path.join("models", f"{SAVE_PREFIX}shared_pid_vanilla_rnn_SL_{SEQUENCE_LENGTH}.pt")
