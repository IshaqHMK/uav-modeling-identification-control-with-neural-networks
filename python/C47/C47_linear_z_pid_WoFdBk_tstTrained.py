...
Step 2:
  ...
  - Rebuild sequences from [error, error_rate, error_integral] for plotting.
...
WIND_FORCE = 3.0  # N (set to 0.0 to disable or change for unseen tests)
...
# Figure saving
SAVE_PREFIX = "C47_testTrained_"
FIG_DIR = os.path.dirname(os.path.abspath(__file__))
# Load the C47 model trained with the 3-level wind disturbance sweep.
...
def main():
    ...
    feature_dim = int(ckpt.get("feature_dim", 3))
