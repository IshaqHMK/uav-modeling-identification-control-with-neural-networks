...
def main():
    ...
    dataset_key = "D1"  # change to D2/D3 as needed
    prefix = f"C40_{dataset_key}"
    checkpoint_candidates = [
        os.path.join(HERE, "models", "C24_ep250_2shared_pid_gru_SL_50.pt"),
        #os.path.join(HERE, "models", "C24_shared_pid_gru_SL_60.pt"),
    ]
