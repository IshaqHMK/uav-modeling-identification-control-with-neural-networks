...
% C63 test MAT plotter (for SLURM headless runs)
% Loads C63_test_results.mat and regenerates C63 test figures in MATLAB.

clear; clc;

base_dir = fileparts(mfilename('fullpath'));
mat_path = fullfile(base_dir, 'mat_results', 'C63_test_results.mat');
out_dir = fullfile(base_dir, 'c63_test_figures_matlab');
