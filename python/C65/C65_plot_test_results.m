% C65 test MAT plotter (for SLURM headless runs)
% Loads C65_test_results.mat and regenerates C65 test figures in MATLAB.

clear; clc;

base_dir = fileparts(mfilename('fullpath'));
mat_path = fullfile(base_dir, 'mat_results', 'C65_test_results.mat');
out_dir = fullfile(base_dir, 'c65_test_figures_matlab');
