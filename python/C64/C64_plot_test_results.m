% C64 test MAT plotter (for SLURM headless runs)
% Loads C64_test_results.mat and regenerates C64 test figures in MATLAB.

clear; clc;

base_dir = fileparts(mfilename('fullpath'));
mat_path = fullfile(base_dir, 'mat_results', 'C64_test_results.mat');
out_dir = fullfile(base_dir, 'c64_test_figures_matlab');
