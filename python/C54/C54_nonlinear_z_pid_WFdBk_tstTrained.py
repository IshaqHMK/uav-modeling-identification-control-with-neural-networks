...
# Roll/pitch references (active only in a time window)
...
# Figure saving
SAVE_PREFIX = "C54_WFdBk_testTrained_"
FIG_DIR = os.path.dirname(os.path.abspath(__file__))
# Load the C54 nonlinear model trained with the APRBS envelope reference.
...
# ------------------------ APRBS Reference (match C54 settings) ------------------------ #
APRBS_WIDTH = 15
APRBS_TAPS = (15, 14)
