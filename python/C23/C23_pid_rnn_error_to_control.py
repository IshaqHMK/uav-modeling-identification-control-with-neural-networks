"""
C23: Unified multi-dataset PID RNN training with shared model.
...
class RNNRegressor(nn.Module):
    """Stacked LSTM followed by a linear head predicting all control channels."""
...
def main():
    ...
    ckpt_path = os.path.join("models", f"{SAVE_PREFIX}shared_pid_rnn_SL_{SEQUENCE_LENGTH}.pt")
