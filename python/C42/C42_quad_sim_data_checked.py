...
def main():
    ...
    total_simulation_time = 50    # Total simulation time in seconds
    ...
    for i in range(num_samples):
        ...
        # Inject disturbance after PID, before saturation/dynamics
    ...
    # Control Input U1
    axs[0, 1].plot(sim_times, control_inputs_history[:, 0], label=r'$U_1$', linewidth=1, color='b')
    ...
    # Control Input U2
    axs[1, 1].plot(sim_times, control_inputs_history[:, 1], label=r'$U_2$', linewidth=1, color='g')
    ...
    # Control Input U3
    axs[2, 1].plot(sim_times, control_inputs_history[:, 2], label=r'$U_3$', linewidth=1, color='orange')
    ...
    # Control Input U4
    axs[3, 1].plot(sim_times, control_inputs_history[:, 3], label=r'$U_4$', linewidth=1, color='purple')
