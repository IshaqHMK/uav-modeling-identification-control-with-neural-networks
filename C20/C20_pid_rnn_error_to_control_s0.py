...
This s0 variant trains independent RNNs for roll, pitch, and yaw commands.
"""
...
# Each tuple: (axis_name, control_short, target_name, plot_label, column_index)
AXES = [
...
def main():
    ...
    train_loader, validation_loader = None, None  # placeholders to satisfy linter hints in IDEs
