...
Follow [aws-hpc-quickstart](https://github.com/IshaqHMK/aws-hpc-quickstart) guide for accessing HPC using AWS Client VPN, AUS SSO, SSH, Amazon DCV, WinSCP, and Slurm.
