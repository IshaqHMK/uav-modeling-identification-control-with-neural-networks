...
# Figure saving
SAVE_PREFIX = "C47_WFdBk_testTrained_"
FIG_DIR = os.path.dirname(os.path.abspath(__file__))
# Load the C47 WFdBk model trained with the 3-level wind disturbance sweep.
MODEL_SAVE_PREFIX = "C47_linear_z_pid_WFdBk_trainedGRUmodel"
